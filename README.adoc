...
image:https://codecov.io/github/lread/rewrite-cljc-playground/coverage.svg?branch=master[code coverage, link=https://codecov.io/github/codecov/example-clojure?branch=master
