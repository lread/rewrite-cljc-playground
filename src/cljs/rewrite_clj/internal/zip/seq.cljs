(ns ^:no-doc rewrite-clj.internal.zip.seq
  (:refer-clojure :exclude [map get assoc seq? vector? list? map? set?])
  (:require [rewrite-clj.internal.zip.base :as base]
            [rewrite-clj.internal.zip.edit :as e]
            [rewrite-clj.internal.zip.find :as f]
            [rewrite-clj.internal.zip.insert :as i]
            [rewrite-clj.internal.zip.move :as m]
