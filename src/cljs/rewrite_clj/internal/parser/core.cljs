(ns rewrite-clj.internal.parser.core
  (:require [rewrite-clj.node :as node]
            ...
            [rewrite-clj.internal.parser.string :refer [parse-string parse-regex]]
            [rewrite-clj.internal.parser.token :refer [parse-token]]
            [rewrite-clj.internal.parser.whitespace :refer [parse-whitespace]]
