...
(def ^{:dynamic true
       :doc "The Clojure reader can add positional metadata.
            This metadata is not in the original source, and therefore assumed to be uninteresting to users of rewrite-clj.
...
(defn form-meta
  "Same as `clojure.core/meta` but respects [[rewrite-clj/*elide-metadata*]].
