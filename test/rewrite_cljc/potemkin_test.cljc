...
(deftest t-straight-imports-meta-data
  (are [?dest ?src]
    ...
    #'t-fn      #'rewrite-cljc.potemkin-t1/t-fn
...
#?(:clj
   (deftest t-straight-imports-macros-meta-data
     (are [?dest ?src]
         (is (= (get-meta ?src) (get-meta ?dest)))
       #'t-macro     #'rewrite-cljc.potemkin-t1/t-macro
       #'t-macro-doc #'rewrite-cljc.potemkin-t1/t-macro-doc)))
...
(deftest t-modified-imports-meta-data
  (are [?dest ?src]
    ...
    #'mod-t-fn      #'rewrite-cljc.potemkin-t2/t-fn
    #'mod-t-fn-doc  #'rewrite-cljc.potemkin-t2/t-fn-doc
    #'mod-t-def     #'rewrite-cljc.potemkin-t2/t-def
    #'mod-t-def-doc #'rewrite-cljc.potemkin-t2/t-def-doc))

#?(:clj
   (deftest t-modified-imports-macros-meta-data
     (are [?dest ?src]
         (is (= (expected-modified-meta ?src) (get-meta ?dest)))
       #'mod-t-macro     #'rewrite-cljc.potemkin-t2/t-macro
