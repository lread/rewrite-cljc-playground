...
* An `sexpr` on a namespaced key or symbol should now work even when navigating down to the node in question
...
:user/kw
user=> (-> (p/parse-string "#::{:a 1 :b 2 s1 3}") n/sexpr)
#:user{s1 3, :b 2, :a 1}
user=> (-> (p/parse-string "::my-alias/kw") n/sexpr)
:my-alias-unresolved/kw
user=> (-> (p/parse-string "#::my-alias{:a 1 :b 2 s1 3}") n/sexpr)
:my-alias-unresolved{s1 3, :a 1, :b 2}
----
...
:my.current.ns/kw
user=> (-> (p/parse-string "#::{:a 1 :b 2 s1 3}") (n/sexpr {:auto-resolve resolver}))
#:my.current.ns{s1 3, :a 1, :b 2}
user=> (-> (p/parse-string "::my-alias/kw") (n/sexpr {:auto-resolve resolver}))
:my.aliased.ns/kw
user=> (-> (p/parse-string "#::my-alias{:a 1 :b 2 s1 3}") (n/sexpr {:auto-resolve resolver}))
#:my.aliased.ns{s1 3, :a 1, :b 2}
----
