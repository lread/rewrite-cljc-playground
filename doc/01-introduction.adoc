...
(-> "{::ns-alias/a 1 ::b 2 c 3}" z/of-string (z/get :user/b) z/node pr)
;; =stdout=>
; <token: 2>
(-> "{::ns-alias/a 1 ::b 2 c 3}" z/of-string (z/get :ns-alias-unresolved/a) z/node pr)
;; =stdout=>
; <token: 1>
(-> "#::{:a 1 :b 2 c 3}" z/of-string (z/get :user/b) z/node pr)
;; =stdout=>
; <token: 2>
(-> "#::{:a 1 :b 2 c 3}" z/of-string (z/get 'user/c) z/node pr)
;; =stdout=>
; <token: 3>
----
