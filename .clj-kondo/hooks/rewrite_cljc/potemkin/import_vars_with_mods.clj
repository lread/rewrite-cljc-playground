(ns hooks.rewrite-cljc.potemkin.import-vars-with-mods
  "clj-kondo has support for potemkin `import-vars`, but does not know about rewrite-cljc's
...
(defn import-vars-with-mods
  ...
  ```
  (do
    (def right* rewrite-cljc.custom-zipper.core/right)
    (def left* rewrite-cljc.custom-zipper.core/left)
    (def up* rewrite-cljc.custom-zipper.core/up)
    (def down* rewrite-cljc.custom-zipper.core/down))
